      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="card shadow-lg p-4 border-0 rounded-4 text-center">
            <h3 class="text-purple mb-4 fw-bold">My Quiz Report</h3>
            <p class="mb-4 text-muted">Download your quiz performance summary as a CSV file.</p>
  ...
  methods: {
    async exportCSV() {
      ...
      try {
        ...
        link.href = url;
        link.setAttribute('download', 'my_quiz_report.csv');
